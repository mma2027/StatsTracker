"""
Fetch squash data from both 2024-25 and 2025-26 seasons and create CSV
"""
...
def fetch_both_seasons():
    ...
    team_2025_26 = "44989"  # 2025-26 season

    # Create fetcher
    fetcher = SquashFetcher()

    # Fetch 2024-25 data
    print(f"\n1. Fetching 2024-25 season data (team {team_2024_25})...")
    ...
    # Fetch 2025-26 data
    print(f"\n2. Fetching 2025-26 season data (team {team_2025_26})...")
